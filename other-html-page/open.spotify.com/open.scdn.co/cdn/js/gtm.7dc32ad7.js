...
function getBabaExperiments() {
    var babaExperiments = document.getElementById('baba') ?
        JSON.parse(document.getElementById('baba').innerHTML) :
        [];

    return babaExperiments
        .map(function(experiment) {
            return [experiment.id, experiment.variant].join('.');
        })
        .join('!');
}
...
(function(w) {
    ...
    w.dataLayer.push({
        ...
        experiments: getBabaExperiments(),
